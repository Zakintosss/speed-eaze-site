...
async function handleRequest(request) {
  try {
    ...
    try {
      console.log('Attempting to store submission with key:', submissionKey);
      ...
      console.log('Successfully stored submission in KV');
    } catch (kvError) {
      ...
      return createErrorResponse('Failed to store submission: ' + kvError.message, 500);
    }
